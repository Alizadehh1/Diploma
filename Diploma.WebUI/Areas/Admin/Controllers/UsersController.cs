...
namespace Diploma.WebUI.Areas.Admin.Controllers
{
    ...
    public class UsersController : Controller
    {
        ...
        public UsersController(DiplomaDbContext db, UserManager<DiplomaUser> userManager)
        {
            this.db = db;
        ...
        public async Task<IActionResult> SetRole(int userId, int roleId, bool selected)
        {
            ...
            if (selected)
            {
                ...
                {
                    await db.UserRoles.AddAsync(new DiplomaUserRole
                    {
                        UserId = userId,
                        RoleId = roleId
                    });
        ...
        public async Task<IActionResult> SetPrincipal(int userId, string principalName, bool selected)
        {
            ...
            if (selected)
            {
                ...
                {
                    await db.UserClaims.AddAsync(new DiplomaUserClaim
                    {
                        UserId = userId,
